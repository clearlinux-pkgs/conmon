...
Version  : 2.0.2
Release  : 2
URL      : https://github.com/containers/conmon/archive/v2.0.2.tar.gz
Source0  : https://github.com/containers/conmon/archive/v2.0.2.tar.gz
...
%prep
%setup -q -n conmon-2.0.2
cd %{_builddir}/conmon-2.0.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1573587971
...
cp %{_builddir}/conmon-2.0.2/LICENSE %{buildroot}/usr/share/package-licenses/conmon/147d5d72b02467b04653ff37be85b8e201e9af66
