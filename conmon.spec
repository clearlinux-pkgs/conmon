...
Version  : 2.0.29
Release  : 5
URL      : https://github.com/containers/conmon/archive/v2.0.29/conmon-2.0.29.tar.gz
Source0  : https://github.com/containers/conmon/archive/v2.0.29/conmon-2.0.29.tar.gz
...
%prep
%setup -q -n conmon-2.0.29
cd %{_builddir}/conmon-2.0.29
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1628298052
...
cp %{_builddir}/conmon-2.0.29/LICENSE %{buildroot}/usr/share/package-licenses/conmon/147d5d72b02467b04653ff37be85b8e201e9af66
cp %{_builddir}/conmon-2.0.29/tools/vendor/github.com/cpuguy83/go-md2man/LICENSE.md %{buildroot}/usr/share/package-licenses/conmon/b7a606730713ac061594edab33cf941704b4a95c
cp %{_builddir}/conmon-2.0.29/tools/vendor/github.com/russross/blackfriday/LICENSE.txt %{buildroot}/usr/share/package-licenses/conmon/da34754c05d40ff81f91de8c1b85ea6e5503e21d
